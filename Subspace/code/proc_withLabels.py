...
#         # 1. Create classification data file
#         classification_data = {
#             "points": [],
...
#                 "predicted_label": knn_predictions[idx],
#             }
#             classification_data["points"].append(point_data)

#         # 2. Create parallel coordinates data
...
#             json.dump(classification_data, class_file, indent=4)

#         # Save parallel coordinates data
#         parallel_file_path = os.path.join(json_folder, "parallel.json")
#         with open(parallel_file_path, "w") as parallel_file:
#             json.dump(parallel_data, parallel_file, indent=4)
