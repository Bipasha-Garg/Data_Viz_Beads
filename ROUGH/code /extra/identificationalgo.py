...
def calculate_and_find_best_p(cluster):
    ...
    # p_values = [0.25, 0.5, 1.0, 2.0, 5.0, float("inf")]
    ...
    while T:
        ...
        # Check the condition
        """The condition if r2 < alpha * r1: checks if the distance r2r2 for the next largest pp is significantly smaller than r1r1 (by a factor of α). If it is, it implies that the lower pp value might be a more efficient representation since the envelope for pp would be tighter."""
        if r2 < alpha * r1:
            best_p = p2
