...
def plot_clusters(X, y_kmeans, centers):
    """Plot the clusters and their centers using the first two dimensions."""
...
def plot_cluster_shapes(X, y_kmeans, centers, cluster_points, analysis_results):
    """Plot the clusters with different shapes based on their p and lp norm values using the first two dimensions."""
...
def plot_cluster_boundaries(X, centers, analysis_results):
    """Plot the boundaries of clusters based on their lp norm values using the first two dimensions."""
    plt.figure(figsize=(8, 6))
...
if __name__ == "__main__":
    ...
    plot_cluster_boundaries(X_iris[:, :2], centers[:, :2], analysis_results)
